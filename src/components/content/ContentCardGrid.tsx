...
export default function ContentCardGrid({ item, type }: ContentCardGridProps) {
    ...
    <article className="group/card rounded-md border border-gray-200 overflow-hidden bg-white hover:shadow-md transition-shadow h-full flex flex-col">
      ...
      <div className="p-4 flex flex-col grow">
        ...
        <div className="mt-auto pt-4 border-t border-gray-100 flex items-center justify-between">
          <Link
            href={linkHref}
            className="text-orange-600 font-semibold text-xs hover:underline flex items-center gap-1"
          >
            {getCtaText()}
          </Link>
