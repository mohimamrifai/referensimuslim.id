    ...
    <div className="max-w-7xl mx-auto pb-12 space-y-6">
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-gray-500">Kelola konten video yang ada di referensimuslim.id</p>
        </div>
        <Link
                      ...
                      <div className="relative w-10 h-10 rounded-md overflow-hidden bg-gray-100 border border-gray-200 aspect-square">
                        {video.image ? (
                          <Image
                            ...
                            unoptimized={video.image.startsWith('/uploads') || video.image.startsWith('/api/view-image')}
                          />
                        ) : (
